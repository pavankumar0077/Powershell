# THIS SCRIPT CALL THE POST API AND GET API FOR 3 REQUESTS OF BOTH AND SAVE THE DATA IN EXCEL FILE,
# BOTH REST ENDPOINT AND PAYLOAD IS HARDCOREDED IN THE SCRIPT.
